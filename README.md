...
| Engine | Layout | Disk | Memory | Ingestion | p50 read latency |
|--------|--------|-----:|-------:|----------:|-----------------:|
| [murr](https://github.com/murrdb/murr) 0.1.8 | Arrow IPC | 4.8 GiB | 9.5 GiB | 2.76M rows/s | 437 us |
| Redis 8.6.1 | feature blob | 1.3 GiB | 10.6 GiB | 1.31M rows/s | 989 us |
| Redis 8.6.1 | Feast HSET | 8.2 GiB | 21.2 GiB | 381K rows/s | 4.28 ms |
| RocksDB | feature blob | 4.3 GiB | 204 MiB | 2.40M rows/s | 3.83 ms |
| PostgreSQL 17 | feature blob | 12.8 GiB | 13.7 GiB | 283K rows/s | 9.26 ms |
| PostgreSQL 17 | Feast columns | 12.7 GiB | 13.5 GiB | 138K rows/s | 8.66 ms |
